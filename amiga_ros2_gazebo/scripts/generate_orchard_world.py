#!/usr/bin/env python3
"""Generate amiga_ros2_gazebo/worlds/orchard_nbv.sdf.
    ...
    <model name="tree_{n:02d}">
      ...
      <link name="link">
        ...
        <visual name="visual">
          ...
          <geometry>
            <mesh>
              <uri>package://amiga_ros2_gazebo/meshes/trees_orchard/{variety}.obj</uri>
            </mesh>
          </geometry>
        </visual>
      </link>
...
GROUND_TILE_TEMPLATE = """        <visual name="ground_tile_{n}">
          ...
          <geometry>
            <mesh>
              ...
              <uri>package://amiga_ros2_gazebo/models/ground/meshes/ground_grass.dae</uri>
